...
SPEC = {
  ...
  "logical_name": "wide_format_time_series",
  "observed_suffix": ".csv",
  "artifact_relative_path": "s41597-022-01788-3/artifact/github/github_github.com__BioRDM_COVID-Wastewater-Scotland/COVID-Wastewater-Scotland-main/data/prevalence_timeseries.csv",
  "target_columns": [
    "2020-05-28",
    "Health_Board",
    "Site"
