...
SPEC = {
  ...
  "observed_suffix": ".csv",
  "artifact_relative_path": "s41597-024-04232-w/artifact/github/github_github.com__j-adamczyk_ApisTox_dataset/ApisTox_dataset-master/outputs/dataset_final.csv",
  "target_columns": [
    "CAS",
    "SMILES",
    "label",
