...
SPEC = {
  ...
  "logical_name": "Diet data",
  "observed_suffix": ".csv",
  "artifact_relative_path": "s41597-020-00676-y/artifact/github/github_github.com__mcarolinegraham_North_Pacific_Marine_Salmon_Diet_Database/North_Pacific_Marine_Salmon_Diet_Database-master/data/diet_data.csv",
  "target_columns": [
    "lat_min",
    "lon_max",
